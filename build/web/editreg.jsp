<%-- 
    Document   : editreg
    Created on : Jun 19, 2021, 10:57:35 PM
    Author     : User
--%>
    ...
    <body>
        ...
        <div class="row main">
            ...
            <div class="col-6">
                ...
                <form name="frmEditreg" action="regController?actionreg=editreg" method="POST">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" name="username" readonly="readonly" value="${reg.getUsername()}">
                                </fieldset>

                                <fieldset class="form-group">
                                    <label> Name :</label>
                                    <input type="text" name="name" value="${reg.getName()}">
                                </fieldset>

                                <fieldset class="form-group">
                                    <label> Password :</label> 
                                    <input type="password" name="password"  value="${reg.getPassword()}">
                                </fieldset>

                                <fieldset class="form-group">
                                    <label> Phone number : </label> 
                                    <input type="number" name="phonenumber"  value="${reg.getPhonenumber()}"> 
                                </fieldset>

                                <fieldset class="form-group">
                                    <label> Email : </label>
                                    <input type="text" name="email"  value="${reg.getEmail()}">
                                </fieldset>

                                <fieldset class="form-group">
                                    <label> Address : </label> 
                                    <input type="text" name="address"  value="${reg.getAddress()}"> 
                                </fieldset>
