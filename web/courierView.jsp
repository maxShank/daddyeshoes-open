<%-- 
    Document   : courierView
    Created on : 18 Jun 2021, 11:31:25 pm
            ...
            <div class="header-desktop___3T36B">
                ...
                <div class="glass-header-bottom-desktop-white___38y1Y">
                    <div class="inner___2IOZ-">
                        <a class="logo-black___30Qp_ big___2Azet" href="<%=request.getContextPath()%>/list">
                        </a>
                        <div class="main-menu___1xu8m">

                            <div class="glass-navigation-flyout-white___20EjX">
                                <a href="<%=request.getContextPath()%>/list" class="label">TRACKING</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        <c:forEach items="${listTracking}" var="tracking">
                            <tr>
                                ...
                                <td><a href="edit?id=<c:out value='${tracking.id}'/>">Update</a></td>
                                <td><a href="delete?id=<c:out value='${tracking.id}'/>">Delete</a></td> 
