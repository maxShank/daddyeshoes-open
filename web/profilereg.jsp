<%-- 
    Document   : profilereg
    Created on : Jun 19, 2021, 10:47:50 PM
    Author     : User
--%>
                        ...
                        <div class="card-body">
                            ...
                            <c:forEach items="${reg}" var="reg">
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <c:out value="${reg.password}"/>
                                </fieldset>

                                <fieldset class="form-group">
                                    <label>Phone number :</label><br>
                                    <c:out value="${reg.phonenumber}"/>
                                </fieldset>
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <c:out value="${reg.address}"/>
                                </fieldset>

                                <a href="regController?actionreg=editreg&username=<c:out value='${reg.username}'/>&password=<c:out value='${reg.password}'/>">Update</a>
                                <a href="regController?actionreg=deletereg&username=<c:out value="${reg.username}"/>">Delete</a>
